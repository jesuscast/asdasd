...
We run advertising campaigns on Facebook to raise awareness about the existence of this plugin. The plugin itself has a conversion tracking pixel to ensure our spending remains in budget. You're able to remove the existence of this pixel in index.php if you'd prefer not to be tracked by Facebook.

== Installation ==

1. Upload `wookite/` to the `/wp-content/plugins/` directory
